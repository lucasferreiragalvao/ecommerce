<?php
    ...
    $app->get("/checkout" , function(){
        ...
        if(!$address->getdeszipcode()) $address->setdeszipgetdeszipcode('');
    ...
    $app->post("/profile" , function(){
        ...
        if($_POST['desemail'] !== $user->getdesemail()){
            ...
            if(User::checkLoginExist($_POST['desemail'])){
                ...
                User::setError("Esse e-mail já está sendo utilizado");
                header("Location: /profile");
                exit();
            }
        }
    ...
    $app->get("/boleto/:idorder",function($idorder){
        ...
        $dadosboleto["endereco1"] = $order->getaddress() . " ".
        $order->getdesdistrict();
        $dadosboleto["endereco2"] = $order->getdescity() . " - ".
        $order->getdesstate() . " - " . $order->getdescountry() . " -  
        ...
        "res". DIRECTORY_SEPARATOR . "boletophp" .DIRECTORY_SEPARATOR.
